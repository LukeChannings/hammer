...
func Bundle(entrypoint string, dest string, minify bool, sourcemap api.SourceMap, extractCSS bool, cssModules bool, defines map[string]string) {
	...
	result := api.Build(api.BuildOptions{
		...
		Sourcemap:         sourcemap,
		Plugins:           []api.Plugin{esbuild.HTTPPlugin(true), esbuild.CSSPlugin(extractCSS, cssModules)},
		Define:            defines,
	})
